...
import CaliforniaMedspaMedicalDirectorGuide from './pages/resources/CaliforniaMedspaMedicalDirectorGuide'
...
import NevadaMedspaMedicalDirectorGuide from './pages/resources/NevadaMedspaMedicalDirectorGuide'
import FloridaMedspaMedicalDirectorGuide from './pages/resources/FloridaMedspaMedicalDirectorGuide'
import TexasMedspaMedicalDirectorGuide from './pages/resources/TexasMedspaMedicalDirectorGuide'
...
export default function App() {
  ...
  return (
    <>
      <ScrollToTop />
      <Navbar />
      <main className={!isHomePage ? 'px-2 pt-[100px] md:pt-0' : ''}>
        <Routes>
          ...
          <Route path="/resources/medical-directors-importance" element={<WhyMedicalDirectorsAreVital />} />
          <Route path="/resources/california-medspa-medical-director-guide" element={<CaliforniaMedspaMedicalDirectorGuide />} />
          ...
          <Route path="/resources/nevada-medspa-medical-director-guide" element={<NevadaMedspaMedicalDirectorGuide />} />
          <Route path="/resources/florida-medspa-medical-director-guide" element={<FloridaMedspaMedicalDirectorGuide />} />
          <Route path="/resources/texas-medspa-medical-director-guide" element={<TexasMedspaMedicalDirectorGuide />} />
          <Route path="/article/:id" element={<WPArticle />} />
